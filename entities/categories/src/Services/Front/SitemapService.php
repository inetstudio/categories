...
use InetStudio\CategoriesPackage\Categories\Contracts\Services\Front\SitemapServiceContract;
...
class SitemapService extends BaseService implements SitemapServiceContract
{
    ...
    public function getItems(): array
    {
        ...
        $transformer = app()->make(
            'InetStudio\CategoriesPackage\Categories\Contracts\Transformers\Front\Sitemap\ItemTransformerContract'
        );
