@inject('categoriesService', 'InetStudio\CategoriesPackage\Categories\Contracts\Services\Back\ItemsServiceContract')
...
<div class="form-group row categories-package">
    ...
    <div class="col-sm-10">
        @if (count($categories) > 0)
            <div class="categories-tree" data-target="categories" data-multiple="true" data-cascade="up"
                 data-selected="{{ old('categories') ? old('categories') : '' }}">
                <ul>
